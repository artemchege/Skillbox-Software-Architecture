...
![image-20211127145305869](image-20211127145305869.png)
...
| Контент менеджер          | Иметь удобную админку по добавлению/редатированию списка доступных товаров. | Мог работать более продуктивно.                              | Реализовать админку с поддержкоой удобного встроенного редактора качественных характеристик товаров. View/edit/create в рамках своей области. |
...
![image-20211128090317961](/home/artem/Documents/Skillbox диплом/image-20211128090317961.png)
...
![](/home/artem/Documents/Skillbox диплом/image-20211128090317961-2.png)
...
![image-20211128155901313](/home/artem/Documents/Skillbox диплом/arch-comparison.png)
...
![N-Tier Architecture in ASP.NET Core | by Udara Bibile | Medium](/home/artem/Documents/Skillbox диплом/pics/n-tier.png)
...
![CRUD Operations Explained. What is CRUD? | by Avelon Pang | Geek Culture |  Medium](/home/artem/Documents/Skillbox диплом/pics/CRUDpng)
...
1. Что такое детализация в артекафакте 1? 
...
4. нейросети на подсказках. 
5. может быть создавать паблики, администрировать их. 
6. будем предпологать что систему доствки/склада/проиводства описывать не надо так как мы создаем приложение в рамках уже существующего предпрития. 
